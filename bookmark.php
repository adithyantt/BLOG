...
// toggle bookmark
$check = mysqli_query($conn, "SELECT * FROM bookmarks WHERE post_id=$post_id AND user_id=$user_id");
if (mysqli_num_rows($check) > 0) {
    mysqli_query($conn, "DELETE FROM bookmarks WHERE post_id=$post_id AND user_id=$user_id");
} else {
